...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<serverengine>.freeze, [">= 2.3.0", "< 3.0.0"])
    s.add_runtime_dependency(%q<http_parser.rb>.freeze, [">= 0.5.1", "< 0.9.0"])
    ...
    s.add_runtime_dependency(%q<strptime>.freeze, [">= 0.2.4", "< 1.0.0"])
    ...
    s.add_development_dependency(%q<async>.freeze, ["~> 1.23"])
    ...
    s.add_dependency(%q<serverengine>.freeze, [">= 2.3.0", "< 3.0.0"])
    s.add_dependency(%q<http_parser.rb>.freeze, [">= 0.5.1", "< 0.9.0"])
    s.add_dependency(%q<sigdump>.freeze, ["~> 0.2.2"])
    s.add_dependency(%q<tzinfo>.freeze, [">= 1.0", "< 3.0"])
    s.add_dependency(%q<tzinfo-data>.freeze, ["~> 1.0"])
    s.add_dependency(%q<strptime>.freeze, [">= 0.2.4", "< 1.0.0"])
